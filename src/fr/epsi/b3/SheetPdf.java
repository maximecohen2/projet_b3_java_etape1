...
public class SheetPdf extends AbstractPdf {
	...
	public void addProduct(Product product) throws DocumentException {
		...
		PdfPCell cell4 = new PdfPCell(new Paragraph(String.format("%.2f",product.getPrixHT()) + "€"));
		...
		PdfPCell cell12 = new PdfPCell(new Paragraph(String.format("%.2f",product.getPrixTTC()) + "€"));
